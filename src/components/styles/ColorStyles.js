export const themes = {
  light: {
    ...
    pricingCard: { backgroundColor: "rgba(255, 255, 255, 0.3)" },

    status: { backgroundColor: "rgba(68, 66, 178, 0.1)" },
  ...
  dark: {
    ...
    pricingCard: { backgroundColor: "rgba(31, 31, 71, 0.6)" },

    status: { backgroundColor: "rgba(0, 0, 0, 0.2)" },
